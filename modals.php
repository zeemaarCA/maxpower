<!-- modals -->
<!-- login popup -->
<div class="modal fade animated zoomIn" id="login" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form action="login.php" method="post" id="customer_login">
...
<!-- signup popup -->
<div class="modal fade animated zoomIn" id="signup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="exampleModalLabel">Sign up in seconds</h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>
    <div class="modal-body">
      <form action="signup.php" method="post" id="customer_signup">
        <div class="row">
          <div class="col-lg-6">
            <div class="form-group">
        ...
        <div class="signup-btn">
          <button type="submit" name="register">Sign me up!</button>
        </div>
      </form>
    </div>
  </div>
...
<!-- about-us model -->
<div class="modal fade animated zoomIn" id="about-us" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
...
<!-- about-us model -->
<!-- contact-us model -->
<div class="modal fade animated zoomIn" id="contact-us" tabindex="-1" role="dialog"
